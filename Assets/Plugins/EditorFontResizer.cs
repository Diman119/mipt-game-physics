...
public class EditorFontResizer : EditorWindow {
    ...
    static void Open() {
        GetWindow<EditorFontResizer>("Editor Font Resizer").minSize = new(180f, 10f);
    }

    const string _configPath = "Assets/Plugins/EditorFontResizer.cfg";
    ...
    Dictionary<string, bool> _foldouts = new();
    ...
    void InitStyles() {
        ...
        _evenBG.margin = _oddBG.margin =
            _evenBG.padding = _oddBG.padding = new();
    }
    ...
    void InitProperties() {
        ...
        foreach (var x in typeof(EditorStyles).GetProperties(flags)) {
            ...
            trackedStyles.Add(s);
            _editorStyles.Add(new("editor." + x.Name, s));
        }
        ...
        foreach (var x in GUI.skin.GetType().GetProperties()) {
            ...
            trackedStyles.Add(s);
            _guiStyles.Add(new("gui." + x.Name, s));
        }
        ...
        foreach (var s in GUI.skin.customStyles) {
            ...
            trackedStyles.Add(s);
            _customStyles.Add(new("custom." + s.name, s));
        }
